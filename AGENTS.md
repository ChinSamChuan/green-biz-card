...
Green Biz Card — a tool that captures contact info, generates a vCard QR code, lets users pay $8.99 to design and order a metal business card, and notifies the builder of confirmed orders.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "195546953+ChinSamChuan@users.noreply.github.com"
  git config user.name "ChinSamChuan"
  ```
